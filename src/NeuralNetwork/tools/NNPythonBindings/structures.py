...
MMContext.CHARS = MMContext.CHARS_CTX = MMContext(b"ABDEFGHJLMNQRTabcdefghijklmnopqrstuvwxyz0123456789.!?-%()&$\":;/+*=@#")
MMContext.ACCENTS = MMContext.ACC_CTX = MMContext(b"\x00\x01\x02\x03\x04\x05")