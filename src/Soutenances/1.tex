...
\subsection{Segmentation de caractères}
	...
	\par Cette architecture ne semblant pas être supportée par les machines de l'ecole, l'excécution du programme réalisant ce processus peut produire des segmentation fault. Ainsi, nous avons réalisé un command parser "proof of concept" permetant de réaliser chaque étape du processus individuellement. Ces commandes sont explicitées dans le README du projet.
...
\begin{lstlisting}
	...
	// Applique la segmentation partielle en caractères de l'image et créer l'architecture resultCharacter/*.bmp
\end{lstlisting}
